describe('test suite OpenNewMedicalRecordEntry', () => {
    it('Doctor open a new medical record entry for the appointment of patient "João Dantas" (CPF = 02367016062) on 2024-07-17 at 08:00', () => {
        ...
        cy.get('[name="new_medical_record_entry"]').type('Testando - Conteúdo da entrada de prontuário do paciente João Dantas para consulta do dia 17-07-2024 às 08am.')
        cy.get('#btSalvar').click()

        // Verificar se a nova entrada de prontuário agora consta na página de detalhes da consulta
        cy.contains('Testando - Conteúdo da entrada de prontuário do paciente João Dantas para consulta do dia 17-07-2024 às 08am.').should('be.visible')
        ...
        cy.contains('17 de Julho de 2024').should('be.visible')
        cy.contains('Testando - Conteúdo da entrada de prontuário do paciente João Dantas para consulta do dia 17-07-2024 às 08am.').should('be.visible')
    })
